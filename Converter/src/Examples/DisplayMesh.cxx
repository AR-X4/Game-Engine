...
//    DisplayMetaDataConnections(lMesh);// <--- prints some meta data
//    DisplayControlsPoints(lMesh);// <--- this sets the vert lists
//    DisplayPolygons(lMesh);		 // <--- this sets fat vert list and tri list
...
//		{
//			vTmp = FBX_vert_fat[k];
//			printf("FBX_fat[%d]: v: %f %f %f s: %f %f n:%f %f %f \n",k,vTmp.x,vTmp.y,vTmp.z,vTmp.s,vTmp.t, vTmp.nx,vTmp.ny, vTmp.nz);
//		}
//
