...
namespace Azul
{
	...
	ShaderObject::ShaderObject()
		:ShaderName(ShaderObject::Name::UNINITIALIZED), programObject(0)
	{
	...
	void ShaderObject::Wash()
	{
		...
		this->ShaderName = ShaderObject::Name::UNINITIALIZED;
		this->programObject = 0;

	}

	void ShaderObject::Set(ShaderObject::Name shaderName, const char* const pShaderBaseFileName)
	{
