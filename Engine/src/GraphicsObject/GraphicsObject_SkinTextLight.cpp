#include "GraphicsObject_SkinTextLight.h"
...
namespace Azul
{
	GraphicsObject_SkinTextLight::GraphicsObject_SkinTextLight(const FBXSkinnedModel*const _pModel, const ShaderObject *const _pShaderObj, Texture::Name _name, Vect& LightColor, Vect& LightPos)
	...
	GraphicsObject_SkinTextLight::~GraphicsObject_SkinTextLight()
	{
		delete poLightColor;
		delete poLightPos;
	...
	void GraphicsObject_SkinTextLight::SetState()
	{
	...
	void GraphicsObject_SkinTextLight::SetDataGPU()
	{
		// use this shader
	...
	void GraphicsObject_SkinTextLight::Draw()
	{
		//The starting point of the IBO
		glDrawElements(GL_TRIANGLES, 3 * this->GetModel()->numTris, GL_UNSIGNED_INT, 0);
	}

	void GraphicsObject_SkinTextLight::RestoreState()
	{
		glEnable(GL_CULL_FACE);
		glFrontFace(GL_CW);
	}
