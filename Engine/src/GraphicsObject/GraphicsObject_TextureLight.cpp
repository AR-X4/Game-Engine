...
namespace Azul
{
	...
	GraphicsObject_TextureLight::GraphicsObject_TextureLight(Model* _pModel, ShaderObject* _pShaderObj, Vect& LightColor, Vect& LightPos, Texture::Name  _name)
	...
	void GraphicsObject_TextureLight::SetDataGPU()
	{
		...
		Matrix view = CameraManager::GetActiveCamera(Camera::Type::PERSPECTIVE_3D)->getViewMatrix();
		Matrix proj = CameraManager::GetActiveCamera(Camera::Type::PERSPECTIVE_3D)->getProjMatrix();
