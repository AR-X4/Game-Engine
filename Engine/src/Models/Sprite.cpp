...
#define SPRITE_DATA_NUM_VERTS (sizeof(SpriteData)/sizeof(Vert_xyzuv))
	...
	Sprite::Sprite(Name Namein)
		:Model(Namein)
	{
		this->privCreateVAO();
	}

	void Sprite::privCreateVAO()
	{
	...
	/*Sprite::Sprite(const char* const modelFileName)
		: Model()
	{
